...
class _SeoulPageState extends State<SeoulPage> {
  ...
  Future<void> _fetchWeather() async {
    final weather = await _weatherService.fetchWeather("Seoul");
    if (weather != null) {
      setState(() {
          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Explore the perfect blend of tradition and modernity in South Korea’s capital city!',
                  textAlign: TextAlign.center,
                ...
                _glassContainer(
                  child: Column(
                    ...
                    children: [
                      ...
                      _attractionRow(Icons.park, "Gyeongbokgung Palace"),
                      _attractionRow(Icons.location_city, "N Seoul Tower"),
                      _attractionRow(Icons.shopping_cart, "Myeongdong Shopping Street"),
                      _attractionRow(Icons.nature_people, "Bukchon Hanok Village"),
                      _attractionRow(Icons.museum, "National Museum of Korea"),
                    ],
                  ),
                ),
                const SizedBox(height: 20),
                ...
                _glassContainer(
                  child: Column(
                    ...
                    children: [
                      ...
                      _contentText("Spring (March to May) for cherry blossoms or Autumn (September to November) for stunning fall foliage."),
                    ],
                  ),
                ),
                const SizedBox(height: 20),
                ...
                _glassContainer(
                  child: Column(
                    ...
                    children: [
                      ...
                      _hotelRow("The Shilla Seoul", "Luxury"),
                      _hotelRow("Lotte Hotel Seoul", "Mid-range"),
                      _hotelRow("Guesthouse Myeongdong", "Budget"),
                    ],
                  ),
                ),
                const SizedBox(height: 20),
                ...
                _glassContainer(
                  child: Column(
                    ...
                    children: [
                      ...
                      _foodRow("🍜 Kimchi Jjigae"),
                      _foodRow("🥩 Korean BBQ (Samgyeopsal)"),
                      _foodRow("🍲 Bibimbap"),
                      _foodRow("🍡 Tteokbokki"),
                      _foodRow("🍵 Korean Matcha Tea"),
                    ],
                  ),
                ),
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => PlanTripPage(cityName: "Seoul")),
                    );
                  },
